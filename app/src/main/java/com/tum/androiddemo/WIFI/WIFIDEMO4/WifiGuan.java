package com.tum.androiddemo.WIFI.WIFIDEMO4;
...
public class WifiGuan extends Activity implements OnClickListener {
	//右侧滚动条按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_wifi_demo4);
		mWifiAdmin = new WifiAdmin(WifiGuan.this);
		init();
	}
	...
	public void init() {
		...
		openNetCard.setOnClickListener(WifiGuan.this);
		closeNetCard.setOnClickListener(WifiGuan.this);
		checkNetCardState.setOnClickListener(WifiGuan.this);
		scan.setOnClickListener(WifiGuan.this);
		getScanResult.setOnClickListener(WifiGuan.this);
		connect.setOnClickListener(WifiGuan.this);
		disconnect.setOnClickListener(WifiGuan.this);
		checkNetWorkState.setOnClickListener(WifiGuan.this);
	}
